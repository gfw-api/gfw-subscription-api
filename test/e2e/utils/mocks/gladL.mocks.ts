...
export const createGLADLGeostoreURLSubscriptionBody = (subscription: Record<string, any>, beginDate: Moment, endDate: Moment, bodyData: Record<string, any> = {}) => {
            ...
            datasets: [
                {
                    ...
                    layers: [
                        'ff797c8d-0c1b-4df5-beb3-20a9b900716a'
                    ],
                    timelineParams: {
