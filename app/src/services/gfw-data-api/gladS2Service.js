...
const DATASET_GLAD_S2_ADM_0 = '/dataset/gadm__integrated_alerts__iso_daily_alerts/latest/query';
const DATASET_GLAD_S2_ADM_1 = '/dataset/gadm__integrated_alerts__adm1_daily_alerts/latest/query';
const DATASET_GLAD_S2_ADM_2 = '/dataset/gadm__integrated_alerts__adm2_daily_alerts/latest/query';
const DATASET_GLAD_S2_WDPA = '/dataset/wdpa_protected_areas__integrated_alerts__daily_alerts/latest/query';
const DATASET_GLAD_S2_GEOSTORE = '/dataset/geostore__integrated_alerts__daily_alerts/latest/query';
const DATASET_GLAD_S2_DOWNLOAD = '/dataset/gfw_integrated_alerts/latest/download';
...
class GladS2Service {
    ...
    static getURLForDownload(startDate, endDate, geostoreId) {
        const sql = `SELECT latitude, longitude, umd_glad_sentinel2_alerts__date, umd_glad_sentinel2_alerts__confidence `
    ...
    static async getAlertsForSubscription(startDate, endDate, params) {
        ...
        const url = await GladS2Service.getURLForSubscription(startDate, endDate, params);
    ...
    static async getDownloadURLs(startDate, endDate, params) {
        const geostoreId = await GeostoreService.getGeostoreIdFromSubscriptionParams(params);
        const uri = GladS2Service.getURLForDownload(startDate, endDate, geostoreId);
        return {
